package com.rotimijohnson.cityapp.walkthrough;
...
import com.rotimijohnson.cityapp.adapter.SliderAdapter;
...
public class WalkthroughActivity extends AppCompatActivity {
    ...
    public void skip(View view){
        Intent intent = new Intent(WalkthroughActivity.this, UserBoardActivity.class);
